...
import { fetchReceptions, updateReception } from "@/api/letanApi"
...
export const ReceptionForm = ({ reception, onClose }: ReceptionFormProps) => {
  ...
  const {
    ...
    const handleEdit = async (data: any) => {
        ...
        if (!reception?.leTanId) {
            console.error("Không có ID Lễ tên để cập nhật.")
            return
        }
        const dataWithId = { ...data, id: reception.leTanId }
        try {
            await dispatch(updateReception(dataWithId)).unwrap()
